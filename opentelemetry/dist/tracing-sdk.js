...
exports.startTracingForSam = exports.startLocalTracing = void 0;
...
const startTracingForSam = async (serviceName, exporterEndpoint = 'http://jaeger:4317') => {
    ...
    const tracingSDK = new sdk_node_1.NodeSDK({
        ...
        spanProcessor: new sdk_trace_base_1.SimpleSpanProcessor(otlpExporter),
        instrumentations: [
            new instrumentation_http_1.HttpInstrumentation(),
            new instrumentation_express_1.ExpressInstrumentation(),
            new instrumentation_nestjs_core_1.NestInstrumentation(),
...
exports.startTracingForSam = startTracingForSam;
